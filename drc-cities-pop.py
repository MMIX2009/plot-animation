...
fig2 = px.scatter(drc, x="Population", y="Growth-Rate", size="Population", color="City", hover_name="City", log_x=True, size_max=18000000, range_x=[10000,18000000], range_y=[0.0001,1],
                animation_frame="Year", animation_group="City")
